...
import com.example.kickunity.ApiService;
import com.example.kickunity.ChangeNameRequest;
import com.example.kickunity.CheckResponse;
...
public class NicknameModifyActivity extends AppCompatActivity {
    ...
    private void changeNickname(String newNickname, String accessToken) {
        ...
        apiService.changeNickname(authorizationHeader, request).enqueue(new Callback<CheckResponse>() {
            @Override
